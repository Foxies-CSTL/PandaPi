 ...
 */
  ...
  #define HOMING_BUMP_MM      { 0, 0, 0 }        //2209 Doc
  #define HOMING_BUMP_DIVISOR { 10, 10, 10 }      //2209
  //#define HOMING_BUMP_MM      { 5, 5, 5 }        //SKR11,14
  //#define HOMING_BUMP_DIVISOR { 2, 2, 2 }        //SKR11
  //#define HOMING_BUMP_DIVISOR { 10, 10, 10 }        //SKR14
  //#define HOMING_BACKOFF_POST_MM { 15, 15, 15 }  //SKR11
  //#define HOMING_BUMP_DIVISOR { 0, 0, 0 }        //2209SKR
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LCD_SET_PROGRESS_MANUALLY   //Define on FLSUNQ_Config
  ...
  //#define BINARY_FILE_TRANSFER  // Define on FLSUNQ_Config (OCTO)
 ...
 */
  ...
  //#define DOGM_SD_PERCENT  //CLASSIC_UI
  ...
  // Western only. Not available for Cyrillic, Kana, Turkish, Greek, or Chinese.
  #define USE_SMALL_INFOFONT  //CLASSIC_UI
...
//
  ...
  #if ANY(DGUS_LCD_UI_FYSETC, DGUS_LCD_UI_HIPRECY, DGUS_LCD_UI_PANDAPI)
    #define DGUS_PRINT_FILENAME           // Display the filename during printing
    #define DGUS_PREHEAT_UI               // Display a preheat screen during heatup

    #if EITHER(DGUS_LCD_UI_FYSETC, DGUS_LCD_UI_PANDAPI)
 ...
 */
#ifdef StallGuard
  //#undef MINIMUM_STEPPER_PULSE //SKR11
  //#define MINIMUM_STEPPER_PULSE 2 //TMC pb avec SENSORLESS si =2
#endif
...
#else
  #define TX_BUFFER_SIZE 16 //0 OCTO 32
#endif
...
#define SERIAL_FLOAT_PRECISION 4  // OCTO
...
//#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP      30//13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             45   // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE             1//0   // (mm) Default retract Z-raise
 ...
 */
//#define ADVANCED_PAUSE_FEATURE    //Define on FLSUNQ_Config
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            3  // (mm) Initial retract.
    ...
    #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
    #define FILAMENT_CHANGE_UNLOAD_LENGTH      850  //FE250 (mm) The length of filament for a complete unload.
 ...
 */
  ...
  #define Z_HYBRID_THRESHOLD     150  //100  //3
   ...
   */
    ...
    //#define X_STALL_SENSITIVITY  102//95 //50//8
    #define X_STALL_SENSITIVITY  125  //95 //SKR11
    //#define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    //#define Y_STALL_SENSITIVITY  102//95 //50//8
    #define Y_STALL_SENSITIVITY  125  //95 //SKR11
    //#define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    //#define Z_STALL_SENSITIVITY  102//95 //50//8
    #define Z_STALL_SENSITIVITY  125  //95 //SKR11
