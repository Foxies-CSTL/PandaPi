 ...
 */
  ...
  #define BAUDRATE_TNT   115200 //octo
#else
  #define BAUDRATE 250000
#endif
...
// Choose the name from boards.h that matches your setup
  ...
  #endif
  #ifdef PANDA_PI
  #define MOTHERBOARD BOARD_PANDAPI_STM32_V28
  #endif
#endif

// Name displayed in the LCD "Ready" message and Info menu
//#if ANY(SKR12PRO, SKR14? SKR14T)
  //#define CUSTOM_MACHINE_NAME "FLSUN QQS-SKR"
//#endif
#ifdef QQSP
  #define CUSTOM_MACHINE_NAME "FLSun QQS-Pro"
#endif
#ifdef Q5
  #define CUSTOM_MACHINE_NAME "FLSun Q5 Fox"
#endif
#ifdef PANDPI
  #define CUSTOM_MACHINE_NAME "FLSun QQS Fox"
#endif
...
//#define MIXING_EXTRUDER
  ...
  #define MIXING_VIRTUAL_TOOLS 32 //16  // Use the Virtual Tool method with M163 and M164
...
#define TEMP_BED_RESIDENCY_TIME  0  //10 (seconds) Time to wait for bed to "settle" in M190
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // FLSUN QQ-S, 200 C with 100% part cooling
      #define DEFAULT_Kp  9.8126
      #define DEFAULT_Ki  1.0807
      #define DEFAULT_Kd  22.2745
    #else
      #ifdef Q5
      ...
      // FIND YOUR OWN: measured after M106 S180 with M303 E0 S230 C8
        #define DEFAULT_Kp 18.0550
        #define DEFAULT_Ki 1.0259
        #define DEFAULT_Kd 79.4422
      #endif
    #endif
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #else
    #define DEFAULT_bedKp 83.30
    #define DEFAULT_bedKi 15.51
    #define DEFAULT_bedKd 298.30
  #endif
  // FIND YOUR OWN: "M303 E-1 S90 C8 U" to run autotune on the bed at 90 degrees for 8 cycles.
  //M303 E-1 C8 S60 =>Memo M304 P57.69 I11.07 D200.41
...
#define DELTA
  ...
  //
  // Delta segments par seconde 100, accélération max 4000, vitesse max 200, 
  // aucune oscillation remarquée jusqu'à présent.(80 OR 160 OR 200)
  #ifdef XP
    #define DELTA_SEGMENTS_PER_SECOND 100  //100quelques blocages pd l'impression(bloc hotend)
  #else                                   ///80 un peu moins de blocages
    #define DELTA_SEGMENTS_PER_SECOND 80   //200 Anycubic_L+(80) Kossel+(160)
  #endif
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_DEFAULT_POINTS 4 //CAL 9  
  #endif
  ...
  #if ENABLED(FLYING)
    #ifdef Pat
    //M665 L279.957 A-0.884 B-0.884 C1.769
    //M665 L279.978 A-0.588 B-0.116 C0.704
    //M665 L280.430 A-0.672 B-0.357 C1.030
    //M665 L280.177 A-0.980 B-0.284 C1.264
    //M665 L280.450 A-0.494 B-0.337 C0.831
    //M665 L280.092 A-0.906 B0.011 C0.896
    //M665 L279.976 A-0.641 B-0.421 C1.062
    //M665 L280.428 A-1.114 B-0.136 C1.25
      #define DELTA_PRINTABLE_RADIUS 130
      #define DELTA_DIAGONAL_ROD 279.717
      #define DELTA_HEIGHT 349.3583
      #define DELTA_ENDSTOP_ADJ { 0.0, -0.5947 -2.1886 }
      #define DELTA_RADIUS 141.8060 
      #define DELTA_TOWER_ANGLE_TRIM { -0.2763, 0.1994, 0.0769 }  //XYZ
      #define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.5460, 0.1680, -0.7150 }    //ABC
      #define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
    //Definition Dimension DELTA
    //#define DELTA_PRINTABLE_RADIUS 130  // (mm)
    //#define DELTA_DIAGONAL_ROD 280.0
    //#define DELTA_SMOOTH_ROD_OFFSET 197.8   //180.8 (mm) PRINTER_RADIUS(Repetier).
    ...
    //X = Alpha (Tower 1) angle trim (Tower Offset)
    //A = Alpha (Tower 1) diagonal rod trim (Rod Length Adjust)
    #else
      #define DELTA_PRINTABLE_RADIUS 130
      #define DELTA_DIAGONAL_ROD 279.79
      #define DELTA_HEIGHT 357.0970
      #define DELTA_ENDSTOP_ADJ { -0.2348, -0.6189, 0.0 }
      #define DELTA_RADIUS 141.3743
      #define DELTA_TOWER_ANGLE_TRIM { 0.1007, 0.0489, -0.1496 }  //XYZ
      #define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.0, 0.0, 0.0 }    //ABC
      #define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
    #endif
  #else
    #ifdef Q5
       #define DELTA_PRINTABLE_RADIUS 100   // K+(127.0) 
       #define DELTA_DIAGONAL_ROD 215.0       // K+(301)
       #define DELTA_HEIGHT 198.0            // K+(277.0)
       ...
       #define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.0, 0.0, 0.0 } //ABC OCTO
       //#define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 } 
    #else
       ...
       #define DELTA_HEIGHT 373.0              // (mm) Get this value from G33 auto calibrate
...
#ifdef StallGuard2
  //#define USE_XMIN_PLUG //SKR11
  //#define USE_YMIN_PLUG //SKR11
#endif
 ...
 */
#ifdef XP
  #define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 210 }  //{ 100, 100, 100, 100}
#else
  #define DEFAULT_MAX_FEEDRATE          { 250, 250, 250, 210 }  //{ 100, 100, 100, 100}
#endif

//#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 200 }  //K+
...
#endif
//#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 9000, 9000 }  //K+
 ...
 * 
 */                                   //600=Jerk 10 and 800 Jerk 5
// No use CLASSIC_JERK => DEVIATION 0.013 = DiamNozzle*(Jerk*Jerk/AccelMax)
//On augmente le JERK quand le poids à bouger est lourd mais JERK bas incompatible vitesse haute.
#ifdef XP
 ...
 *  M205 
 * B : le temps minimum passé à traverser un segment - cela ralentira votre imprimante pour un segment si ce segment était terminé plus vite que cette fois.
 * C : un peu l'opposé, plus votre imprimante bougera le plus lentement - super pour prévenir la diffusion de chaleur vers le bas en sections fragiles
 * T : le plus lent que votre imprimante se déplace quand vous n'imprimez pas - je ne sais pas pourquoi cela est nécessaire.
 *
 */
#define CLASSIC_JERK  //DELTA
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK XYZJERK  //15 alexeyzel 5 ALP
  #define DEFAULT_YJERK XYZJERK
  #define DEFAULT_ZJERK XYZJERK // Must be same as XY for delta
...
#define DEFAULT_EJERK   EJERK //5.0  //15 alexeyzel May be used by Linear Advance
 ...
 */
#if ANY(QQSP, Q5, PANDA_PI)
  #ifdef StallGuard2
    #undef Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //SKR11
  #else  
 ...
 */
#if ANY(StallGuard2, TCHM2, BLTOUCH)
  #undef FIX_MOUNTED_PROBE //2209 TCHM2SKR11
#else
  #define FIX_MOUNTED_PROBE //2209 TCHM2
#endif
 ...
 */
#ifdef StallGuard2
  #define SENSORLESS_PROBING  //2209SKR11
#endif
 ...
 */
#ifdef TCHM
  #define NOZZLE_TO_PROBE_OFFSET { 0, -35, -4.3812 }  //
#else
  #ifdef BLTOUCH
    #define NOZZLE_TO_PROBE_OFFSET { 0, -40, -11.7 }
  #else
    #define NOZZLE_TO_PROBE_OFFSET { 0, 0, Z_OFFSET }  // (Stock 16.2)
  #endif
#endif

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#if ANY(TCHM2, StallGuard2)
  #define PROBING_MARGIN 20//35
#else
...
#if ANY(StallGuard2, TCHM2, BLTOUCH)
  #undef PAUSE_BEFORE_DEPLOY_STOW //SKR11
#else
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR  //Define on FLSUNQ_Config
 ...
 */
//#define DEBUG_LEVELING_FEATURE       //Define on FLSUNQ_Config

#if ANY(MESH_BED_LEVELING, AUTO_BED_LEVELING_BILINEAR, AUTO_BED_LEVELING_UBL)
  // Gradually reduce leveling correction until a set height is reached,
  // at which point movement will be level to the machine's XY plane.
  // The height can be set with M420 Z<height>
  #define ENABLE_LEVELING_FADE_HEIGHT // Fix line under 10mm
  ...
  //#define MESH_EDIT_GFX_OVERLAY  //CAL FSMC   // Display a graphics overlay while editing the mesh
    ...
    #define GRID_MAX_POINTS_X 8       //OPT Don't use more than 15 points per axis, implementation limited.
  #else
    #define MESH_INSET 30             // Set Mesh bounds as an inset region of the bed
    #define GRID_MAX_POINTS_X 8//7       //OPT Don't use more than 15 points per axis, implementation limited.
 ...
 */
//#define LCD_BED_LEVELING //Define on FLSUNQ_Config Possible bug Mesh edit
...
//#define DGUS_LCD_UI_PANDAPI //PANDA_PI
